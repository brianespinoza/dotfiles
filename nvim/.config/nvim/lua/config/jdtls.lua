-- https://www.youtube.com/watch?v=zbpF3te0M3g&ab_channel=UnknownKoder
        ...
        java = {
            ...
            configuration = {
                ...
                runtimes = {
                    {
                        name = "JavaSE-21",
                        path = "/Users/brianespinoza/.sdkman/candidates/java/21.0.6-tem/",
                    },
                    {
                        name = "JavaSE-17",
                        path = "/Users/brianespinoza/.sdkman/candidates/java/17.0.14-amzn/",
                    },
                }
            },
