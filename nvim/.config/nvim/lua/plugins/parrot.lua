return {
    ...
    keys = {
        { "<leader>pa", "<cmd>PrtAsk<cr>",          desc = "Toggle ask" },
        { "<leader>pn", "<cmd>PrtChatNew<cr>",      desc = "Chat new" },
        { "<leader>pr", "<cmd>PrtChatResponde<cr>", desc = "Chat response" },
        { "<leader>pt", "<cmd>PrtChatToggle<cr>",   desc = "Toggle chat" },
        { "<leader>pp", ":'<,'>PrtChatPaste<cr>",   desc = "Chat paste" },
    },
}
